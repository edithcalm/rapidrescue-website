          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
              ...
              <div class="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/company/warn-et/" class="text-gray-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    <p class="text-gray-400 text-sm">warnet@gmail.com, warnet@eveshield.org</p>
                  </div>
                </div>
              </div>
            </div>
